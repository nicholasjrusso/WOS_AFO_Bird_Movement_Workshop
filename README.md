...
`Step 1 - Data Prep and Visualization.R`: R script that shows how to make a "track" object, visualize a movement track, standardize the temporal sampling rate of the track, generate random steps, and extract covariates at the end of each used and random movement step.
...
- `DjaFaunalReserveOSM.shp`: Shapefile of Cameroon's Dja Faunal Reserve to make the movement track map look nice
...
other attached packages:
 [1] sf_1.0-19       forcats_1.0.0   stringr_1.5.2   dplyr_1.1.4    
 [5] purrr_1.0.2     readr_2.1.5     tidyr_1.3.1     tibble_3.3.0   
 [9] ggplot2_4.0.0   tidyverse_2.0.0 terra_1.8-70    lubridate_1.9.3
[13] amt_0.2.2.0    
...
[13] pkgload_1.4.0      mvtnorm_1.3-2      Matrix_1.7-1       backports_1.5.0   
[17] e1071_1.7-16       DBI_1.2.3          survival_3.7-0     viridisLite_0.4.2 
[21] scales_1.4.0       codetools_0.2-20   Rdpack_2.6.2       cli_3.6.3         
[25] rlang_1.1.4        units_0.8-5        rbibutils_2.3      splines_4.4.2     
[29] withr_3.0.2        tools_4.4.2        tzdb_0.5.0         checkmate_2.3.2   
[33] boot_1.3-31        fitdistrplus_1.2-1 vctrs_0.6.5        R6_2.6.1          
[37] proxy_0.4-27       lifecycle_1.0.4    classInt_0.4-10    MASS_7.3-61       
[41] pkgconfig_2.0.3    pillar_1.11.1      gtable_0.3.6       data.table_1.16.4 
[45] glue_1.8.0         Rcpp_1.0.13-1      tidyselect_1.2.1   rstudioapi_0.17.1 
[49] farver_2.1.2       compiler_4.4.2     S7_0.2.0
